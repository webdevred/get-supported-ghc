...
function boundOp(bound, type2) {
  return bound.inclusive ? `${type2}=` : type2;
}
...
${ghcupListStr.slice(0, 500)}`
    ...
    const validVersions = ghcupList.filter(
      (ghcEntry) => satisfiesUpperBound(ghcEntry.base, baseUpperBound)
    );
